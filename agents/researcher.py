"""
===============================================================================
                    🔬 研究智能体 (Researcher Agent) v2.0 (Exa AI版)
===============================================================================
核心功能：
1. 优先使用 Exa AI 进行智能聚合搜索 (自动关键词 + 领域过滤)
2. 获取 Exa 清洗后的全文内容 (跳过爬虫步骤)
3. 备用：使用 Tavily + Jina Reader 进行兜底
4. 使用 DeepSeek 整理全文内容，生成结构化写作笔记
===============================================================================
"""
...
class ResearcherAgent:
    ...
    def synthesize_notes(self, items: list[dict], topic: str) -> str:
        ...
        prompt = f"""你是一位专业内容研究员。请根据以下多篇来源文章，为公众号文章《{topic}》整理素材。
